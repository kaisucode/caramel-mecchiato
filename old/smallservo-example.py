...
test.move_servo_position(halfservochannel, 0, 180)

# Pause 1 sec
time.sleep(1)

# Moves servo position to 180 degrees (2ms), Channel 0
test.move_servo_position(halfservochannel, 180, 180)
...
while True:
    for i in range(0, 180):
        print(i)
        test.move_servo_position(halfservochannel, i, 180)
        test.move_servo_position(0, i, 180)
        test.move_servo_position(4, i, 180)
        time.sleep(.001)
